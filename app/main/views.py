...
from . import main
from ..requests import get_top_headlines, get_sources, get_by_language, get_by_category, view_articles
...
def source_articles_page(id):
    news_articles = view_articles(id)
    title = id
